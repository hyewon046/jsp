...
<header>
	...
	<div id="loginArea">
		...
		<form name="loginForm" action="/login.do" method="post">
			...
			<input type="button" value="회원가입" onclick="location.href='/insertMemberForm.do';" class="btn btn-secondary btn-sm">
		</form>
		</c:if>
		<c:if test="${!empty sessionScope.ss_mid}">
			${sessionScope.ss_mid}님 로그인 중!&nbsp;
			<input type="button" value="로그아웃" onclick="location.href='/logout.do';" class="btn btn-primary btn-sm" >
		</c:if>
	</div>
