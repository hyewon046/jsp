...
INSERT INTO AUTHOR
VALUES(SEQ_AUTHOR.NEXTVAL, 'USERNAME', 'PASSWORD', 'EMIAL', 'BIO', 'FAVOURITE_SECTION');
SELECT * FROM AUTHOR;

INSERT INTO BLOG
VALUES(SEQ_BLOG.NEXTVAL, 'TITLE', 1);
SELECT * FROM BLOG;

INSERT INTO POST
VALUES(SEQ_POST.NEXTVAL, SYSDATE, 'SECTION', 'SUBJECT', 1, 'BODY', 1, 1);
SELECT * FROM POST;

INSERT INTO TAG
VALUES(SEQ_TAG.NEXTVAL, 'NAME', 3);
SELECT * FROM TAG;

INSERT INTO CMT
VALUES(SEQ_CMT.NEXTVAL, 'NAME', 'COMMENT', 4);
SELECT * FROM CMT;
