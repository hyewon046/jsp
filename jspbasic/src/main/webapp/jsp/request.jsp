...
- GET방식요청시에는 주소 뒤에 ?변수명=값&변수명=값... 식으로 전달
- POST방식요청시에는 request body에 변수와 값이 포함되어 전달
--%>
